...
export default function MainSection() {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-center items-center lg:mt-[4vh] mt-[2vh] px-4 sm:px-8 lg:px-12 max-w-6xl mx-auto gap-6 lg:gap-12">
            <div className="lg:mt-[8vh] w-full lg:max-w-[50%] text-center lg:text-left">
                ...
                <div className="mt-8 space-y-3 text-left">
                    <div className="flex items-center gap-3">
                        <FaCheckCircle size="20px" className="text-[#8EF27E] w-5 h-5" />
            ...
            <div className="flex justify-center w-full lg:w-[50%]">
                <Image className="w-[100%] sm:w-[90%] md:w-[80%] lg:w-[600px] xl:w-[700px] max-w-[900px] lg:mt-3 mt-8 rounded-lg" src={PauloHero} alt="Sessão Individual" loading="lazy" />
            </div>
        </div>
    );
}